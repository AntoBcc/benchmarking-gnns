...
seed=41
#seed=42
dataset=tsp30-40_gen
model=GatedGCN-hybrid


python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 1

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 2

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 5
...
python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 30

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 40

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 50

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 60

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 70

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 80

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 90
...
python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 300

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 400

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 500

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 600

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 700

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 800

python $code --dataset $dataset --gpu_id 0 --seed $seed --config $config --edge_feat True --train_size 900
